...
class CommentLikesViewTests(TestCase):
    ...
    def test_no_comment_likes(self):
        ...
        """
        response = self.client.get(f'/api/v1/author/{self.author_id}/posts/{self.post_id}/comments/{self.comment_id}/likes/')
    ...
    def test_comment_like_belongs_to_author(self):
        ...
        util.create_comment_like(author_2, post_2, comment_2)
        response_1 = self.client.get('/api/v1/author/{}/posts/{}/comments/{}/likes/'.format(self.author_id, post_1.id, comment_1.id))
        response_2 = self.client.get('/api/v1/author/{}/posts/{}/comments/{}/likes/'.format(author_2.id, post_2.id, comment_2.id))
