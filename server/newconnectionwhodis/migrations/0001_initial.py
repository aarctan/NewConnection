# Generated by Django 3.2 on 2021-10-24 02:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(default='author', editable=False, max_length=512)),
                ('host', models.URLField(editable=False, max_length=512)),
                ('url', models.URLField(editable=False, max_length=512)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('type', models.CharField(default='comment', editable=False, max_length=512)),
                ('published', models.DateTimeField(default='2021-10-24T02:41:48.232369+00:00', editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('type', models.CharField(default='post', editable=False, max_length=512)),
                ...
                ('published', models.DateTimeField(default='2021-10-24T02:41:48.231034+00:00', editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('type', models.CharField(default='Like', editable=False, max_length=512)),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='newconnectionwhodis.author')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(default='inbox', editable=False, max_length=512)),
