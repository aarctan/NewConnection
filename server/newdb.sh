...
./manage.py shell -c "from newconnectionwhodis import models; a = models.Author.objects.get(displayName='Muhammad'); a.profileImage='https://avatars.githubusercontent.com/u/83198532?v=4'; a.save();"
./manage.py shell -c "from django.contrib.auth.models import User; User.objects.create_superuser('Dylan', '', 'admin')"
./manage.py shell -c "from newconnectionwhodis import models; a = models.Author.objects.get(displayName='Dylan'); a.profileImage='https://avatars.githubusercontent.com/u/69830467?v=4'; a.save();"
