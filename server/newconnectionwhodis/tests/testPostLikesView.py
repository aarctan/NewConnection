...
class PostLikesViewTests(TestCase):
    ...
    def test_no_post_likes(self):
        ...
        response = self.client.get(
            f"/api/v1/author/{self.author_id}/posts/{self.post_id}/likes/"
        )
    ...
    def test_post_like_belongs_to_author(self):
        ...
        response_1 = self.client.get(
            "/api/v1/author/{}/posts/{}/likes/".format(self.author_id, post_1.id)
        )
        response_2 = self.client.get(
            "/api/v1/author/{}/posts/{}/likes/".format(author_2.id, post_2.id)
        )
